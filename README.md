...
1. Go to [releases](https://github.com/chrisilly/Playful/releases) and under the `Assets` dropdown menu of the latest release, click on and download the `.mrpack` file
...
## Importing from GitHub to a modlauncher

### Modrinth
1. In the Modrinth app, press the plus icon in the bottom left corner
2. In the Create Instance window, press `From File`

![modrinth_create-instance-window_cropped_transparent](https://github.com/chrisilly/Playful/assets/103900975/47945f45-fe31-4bba-a428-f555a3b688e2)
